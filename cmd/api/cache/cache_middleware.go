...
type CacheMiddleware struct {
	...
	expirationFunc cache.ExpirationFunc
}

func Middleware(cache cache.ICache, skipper middleware.Skipper, expirationFunc cache.ExpirationFunc) echo.MiddlewareFunc {
