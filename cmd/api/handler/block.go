...
//
//	@Summary		List blocks
//	@Description	Returns a paginated list of blocks. Blocks can be sorted by height in ascending or descending order. Optionally includes statistical data for each block.
//	@Tags			block
//	@ID				list-block
