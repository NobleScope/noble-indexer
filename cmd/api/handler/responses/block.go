...
func NewBlock(block storage.Block) Block {
	resultBlock := Block{
		...
		ParentHash:           block.ParentHashHash.String(),
		...
		StateRoot:            block.StateRootHash.String(),
		TotalDifficultyHash:  block.TotalDifficultyHash.String(),
		TransactionsRootHash: block.TransactionsRootHash.String(),
	}
