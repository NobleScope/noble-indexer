    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/responses.ContractCode"
                        }
                    },
                    "204": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/responses.ProxyContract"
                            }
                        }
                    },
                    "400": {
        ...
        "/token_balances": {
            "get": {
                ...
                "operationId": "list-token-balances",
                "parameters": [
                    {
                        "maximum": 100,
                        "minimum": 1,
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "type": "integer",
                        "default": 10,
                        "description": "Number of user operations to return (default: 10)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        ...
                        "type": "integer",
                        "default": 0,
                        "description": "Number of user operations to skip (default: 0)",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "minLength": 42,
                        "type": "string",
                        "description": "Filter by bundler address",
                        "name": "bundler",
                        "in": "query"
                    },
                    {
                        ...
                        "minLength": 42,
                        "type": "string",
                        "description": "Filter by paymaster address",
                        "name": "paymaster",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "responses.Address": {
            ...
            "properties": {
                ...
                "hash": {
                    "type": "string",
                    "example": "0xd90d69b7cf347b5bfe0719baf7eef310c085e46b"
                },
                "id": {
                    "type": "integer",
                    "example": 321
        ...
        "responses.Contract": {
            ...
            "properties": {
                ...
                "metadata_link": {
                    "type": "string",
                    "example": "https://ipfs.io/ipfs/QmWYtNwHxXxzhrWj7TUcB5tC3m1bSGFXAtEqwegMbk1sjt"
                },
                "optimizer_enabled": {
                    "type": "boolean",
                    "example": true
        ...
        "responses.ContractCode": {
            ...
            "properties": {
                ...
                "code": {
                    "type": "string",
                    "example": "0x01234567890123456789012345678901234567890123456789"
                }
            }
        },
        "responses.Enums": {
        ...
        "responses.SearchItem": {
            ...
            "properties": {
                "result": {
                    "description": "Search result. Can be one of folowwing types: Address, Block, Tx, Token",
                    "type": "object"
                },
                "type": {
