...
func (m *MockITransfer) Filter(ctx context.Context, filter storage.TransferListFilter) ([]storage.Transfer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockITransferMockRecorder) Filter(ctx, filter any) *MockITransferFilterCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Filter", reflect.TypeOf((*MockITransfer)(nil).Filter), ctx, filter)
	return &MockITransferFilterCall{Call: call}
}

// MockITransferFilterCall wrap *gomock.Call
type MockITransferFilterCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockITransferFilterCall) Return(arg0 []storage.Transfer, arg1 error) *MockITransferFilterCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockITransferFilterCall) Do(f func(context.Context, storage.TransferListFilter) ([]storage.Transfer, error)) *MockITransferFilterCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockITransferFilterCall) DoAndReturn(f func(context.Context, storage.TransferListFilter) ([]storage.Transfer, error)) *MockITransferFilterCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Get mocks base method.
func (m *MockITransfer) Get(ctx context.Context, id uint64) (storage.Transfer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockITransferMockRecorder) Get(ctx, id any) *MockITransferGetCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockITransfer)(nil).Get), ctx, id)
	return &MockITransferGetCall{Call: call}
}

// MockITransferGetCall wrap *gomock.Call
type MockITransferGetCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockITransferGetCall) Return(arg0 storage.Transfer, arg1 error) *MockITransferGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockITransferGetCall) Do(f func(context.Context, uint64) (storage.Transfer, error)) *MockITransferGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockITransferGetCall) DoAndReturn(f func(context.Context, uint64) (storage.Transfer, error)) *MockITransferGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
